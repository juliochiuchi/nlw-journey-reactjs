...
export function InviteGuestsStep({
  ...
  return (
    <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
      <button type="button" onClick={handleOpenModalGuests} className="flex items-center gap-2 flex-1 text-left">
      ...
      <Button variant="primary" onClick={handleOpenConfirmTripModal}>
